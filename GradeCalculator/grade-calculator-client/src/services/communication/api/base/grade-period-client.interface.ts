...
import { MoveGradePeriodDto } from 'src/services/communication/api/request/grade-period/move-grade-period';
...
export abstract class IGradePeriodClient {
  ...
  public abstract moveGradePeriod(request: MoveGradePeriodDto): Observable<void>;
